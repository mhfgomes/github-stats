...
- `/api/stats` discovers commits across branches and recent PR heads (full walk for normal repos; huge 100+ branch repos use search + HEAD + PRs), batches diff stats via GraphQL with REST fallback, and caches responses in-memory for 2 minutes.
